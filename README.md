...
[Download](./dist/shortapi.min.js) and include the Shortapi library after ForgeJS.

`<script type="text/javascript" src="shortapi.min.js"></script>`
...
```
/* Call the methods */
shortapi.nameOfTheMethods(options);

/* Optionally rename the shortapi name */
var yourHelperName = shortapi;

/* And then call metehods with your custom name */
yourHelperName.nameOfTheMethods(options);
```
